...
<div class="pt:mt-0 mx-auto flex flex-col items-center justify-center px-6 pb-24 md:h-screen">
  ...
  <a href="/" class="mb-8 flex items-center justify-center text-2xl font-semibold lg:mb-10" style="color:#c34a2c">
  ...
  <div class="w-full max-w-xl space-y-8 rounded-md border bg-white p-6 shadow sm:p-8">
    ...
    <h2 class="text-2xl font-bold text-green-900" style="color:#c34a2c">[create_new_account]</h2>
    ...
    <form action="?/register" method="POST" use:enhance class="mt-8 space-y-6">
      <div>
        ...
        <label for="[email]" class="mb-2 block text-sm font-bold text-purple-900" style="color:#c34a2c"> [email] </label>
        <input
          id="email"
          name="email"
          type="email"
          ...
          class="block w-full rounded-md border border-black-300 bg-coral-50 p-2.5 text-purple-900 focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
        />
      </div>

      <div>
        <label for="password" class="mb-2 block text-sm font-medium text-gray-900"> Password </label>
        <label for="password" class="mb-2 block text-sm font-bold text-gray-900"style="color:#c34a2c"> [password] </label>
        <input
          id="password"
          name="password"
          type="password"
      ...
      <div>
        <label for="confirm-password" class="mb-2 block text-sm font-medium text-gray-900">
          Confirm password
        <label for="confirm-password" class="mb-2 block text-sm font-bold text-gray-900"style="color:#c34a2c">
          [confirm_password]
        </label>
        <input
      ...
      <button
        ...
        class="w-full rounded-md bg-red-700 px-5 py-3 text-center text-base font-medium text-white hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 sm:w-auto" 
        style="background-color:#c34a2c"
      >
        Create account
      </button>
      ...
      <div class="text-sm font-medium text-yellow-500">
        Already have an account? <a href="/login" class="text-primary-700 hover:underline" style="color:#c34a2c">Login</a>
      </div>
    </form>
  </div>
</div>
