...
>
  ...
  <div class="w-full max-w-xl space-y-8 rounded-md border p-6 shadow sm:p-8">
    <h2 class="text-2xl font-bold text-yellow-900" style="color:#c34a2c">
      [sign_into_squire]
    </h2>
    ...
    >
      <div>
        <label
          for="email"
          class="mb-2 block text-sm font-bold text-yellow-900"
          style="color:#c34a2c"
        >
          [email]
        </label>
        <input
          ...
          autocomplete="email"
          required
          class="border-black-300 bg-coral-50 block w-full rounded-md border p-2.5 text-purple-900 focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
        />
      </div>
      ...
      <div>
        <label
          for="password"
          class="mb-2 block text-sm font-bold text-yellow-900"
          style="color:#c34a2c">[password]</label
        >
        <input
          id="password"
          name="password"
      ...
      <div class="flex items-start">
        <a
          ...
          class="ml-auto text-sm text-yellow-700 hover:underline"
        >
          Forgot Password?
        </a>
      </div>
      ...
      <div class="text-sm font-medium text-yellow-500">
        ...
        <a href="/register" class="text-red-700 hover:underline">
          Create account!
        </a>
      </div>
    </form>
