...
const Avatar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
  return `<div class="overflow-clip rounded-full"><!-- HTML_TAG_START -->${userAvatar(
    email
  )}<!-- HTML_TAG_END --></div>`;
});
const css = {
...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<nav style="position: fixed; top: 0; left: 0; width: 100%;"><div style="padding: 1rem; lg:padding: 1.25rem; lg:padding-left: 3rem; max-height: 2rem;"><div style="display: flex; align-items: center; justify-content: space-between; max-height: 2rem;"><div style="margin-left: 0.5rem; display: flex; align-items: center; justify-content: flex-start;"><a href="/" class="flex items-center space-x-2">
      ...
      <div style="display: flex; gap: 16px; justify-content: center;"><a class="btn dark svelte-18hhbin" href="/chatrooms" id="Nav-Chat">Chatrooms</a>
        ...
        ${
          user.id == 2
            ? `<a class="btn dark svelte-18hhbin" href="/sendNot" id="Nav-Send">send</a>`
            : ``
        }
            ...
            escape(
              null_to_empty(
                clsx(
                  ...
                  { visible: showMenu, invisible: !showMenu }
                )
              ),
              true
            ) + " svelte-18hhbin"
          }" id="dropdown-2"><div class="px-4 py-3" role="none">
              <p class="truncate text-sm font-medium text-gray-900" role="none">${escape(
                user.email
              )}</p></div>
...
const Main = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<main><div class="container mx-auto px-4 pt-24" style="height: 100%; width: 100%">${
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${
    (($$result.head += `<!-- HEAD_svelte-1law5hj_START -->${
      (($$result.title = `<title>${escape(title)}</title>`), "")
    }<meta name="description"${add_attribute(
      "content",
      description,
      0
    )}><!-- HEAD_svelte-1law5hj_END -->`),
    "")
  }

<div class="min-h-full">${validate_component(Navbar, "Navbar").$$render(
    $$result,
    { user: data.user },
    {},
    {}
