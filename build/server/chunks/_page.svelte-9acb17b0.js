...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="p-4"><div class="mb-4"><h1 class="text-lg font-semibold">Create Chatroom</h1>
    <div class="flex gap-2 items-center mt-2"><input class="border p-2 rounded" placeholder="User Name"${add_attribute(
      "value",
      username,
      0
    )}>
  ...
  <div class="mb-4">${each(userNames, (id) => {
    return `<div class="flex gap-2 items-center"><p class="mr-2">${escape(
      id
    )}</p>
  ...
  ${
    addedUsers.length > 0
      ? `<div class="mb-4"><h2 class="text-lg font-semibold">Added to groupchat:</h2>
      ${each(addedUsers, (id) => {
        return `<p>${escape(id)}</p>`;
      })}
      <div class="flex gap-2 items-center mt-2"><h2 class="text-lg font-semibold">Chatroom name</h2>
        <input class="border p-2 rounded" placeholder="Chatname" maxlength="14"${add_attribute(
          "value",
          chatname,
          0
        )}>
...
//# sourceMappingURL=_page.svelte-9acb17b0.js.map
