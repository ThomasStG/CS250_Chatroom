              ...
              return `${
                room.Chatroom
                  ? `<a href="${
                    ...
                    }" class="block mx-auto mb-4 rounded-lg bg-gray-800 p-6 hover:bg-gray-700"><p class="text-xl text-white">Room Name: ${escape(
                      room.name
                    )}</p>
              </a>`
                  : ``
          ...
          ? `${each(rooms, (room) => {
              return `${
                room && room.Chatroom === false
                  ? `<a href="${
                      "/chatrooms/" + escape(room.id, true)
                    }" class="block mx-auto mb-4 rounded-lg bg-gray-800 p-6 hover:bg-gray-700"><p class="text-xl text-white">${
                      usr
                        ? `Friend Name: ${escape(
                            room.name.replace("‎", "").replace(usr.username, "")
                          )}`
                        : ``
                    }</p>
              </a>`
...
//# sourceMappingURL=_page.svelte-f2ce155e.js.map
