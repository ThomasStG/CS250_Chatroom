...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="background flex min-h-screen flex-col items-center">${
      roomName && roomName.name
        ? `<h1 class="mb-4 text-center text-4xl font-extrabold md:text-5xl lg:text-6xl">Room: ${escape(
            roomName.name
          )}</h1>
...
//# sourceMappingURL=_page.svelte-b6d20363.js.map
