import { q as d, s as w } from "./index.229400e6.js";
const u = [];
function p(e, t = d) {
  let n;
  const o = new Set();
...
var g;
const E = ((g = globalThis.__sveltekit_8hg0eq) == null ? void 0 : g.base) ?? "";
var k;
const A =
    ((k = globalThis.__sveltekit_8hg0eq) == null ? void 0 : k.assets) ?? E,
  R = "1701883531141",
...
const j = { url: h({}), page: h({}), navigating: p(null), updated: S() };
export {
  x as I,
  _ as P,
  q as S,
