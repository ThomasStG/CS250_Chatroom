...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/chatrooms" | "/(app)/chatrooms/[slug]" | "/(app)/chatrooms/[slug]/edit" | "/(app)/chatrooms/create" | "/(app)/chatrooms/create.backup" | "/(app)/directMessage" | "/(app)/friends" | "/(app)/globalChat" | "/(app)/notifications" | "/(app)/notifications/[slug]" | "/(app)/sendNot" | "/(app)/settings"
