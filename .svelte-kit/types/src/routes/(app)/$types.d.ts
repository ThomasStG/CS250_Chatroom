...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/chatrooms" | "/(app)/chatrooms/[slug]" | "/(app)/chatrooms/create" | "/(app)/chatrooms/create.backup" | "/(app)/directMessage" | "/(app)/friends" | "/(app)/notifications" | "/(app)/settings"
