...
type MatcherParam<M> = M extends (param: string) => param is infer U
  ...
  : string;
type RouteParams = {};
type RouteId = "/(app)/directMessage";
...
type LayoutRouteId = RouteId | "/(app)/directMessage";
type LayoutParams = RouteParams & {};
type LayoutServerParentData = Omit<
...
export type LayoutServerLoad<
  OutputData extends OutputDataShape<LayoutServerParentData> = OutputDataShape<LayoutServerParentData>
> = Kit.ServerLoad<
  LayoutParams,
