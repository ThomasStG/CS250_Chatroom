...
type LayoutRouteId = RouteId | "/(app)" | "/(app)/chatrooms" | "/(app)/chatrooms/[slug]" | "/(app)/chatrooms/create" | "/(app)/friends" | "/(app)/settings" | "/(auth)/login" | "/(auth)/logout" | "/(auth)/register" | null
