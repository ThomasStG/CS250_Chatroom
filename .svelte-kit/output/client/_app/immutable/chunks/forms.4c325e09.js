import { p as g } from "./parse.bee59afc.js";
import { c as E } from "./singletons.dd9c9a0a.js";
import { i as w } from "./navigation.71f60e69.js";
function L(t) {
...
function H(t, i = () => {}) {
  const l = async ({
    ...
    c.type === "success" &&
      (n && HTMLFormElement.prototype.reset.call(t), r && (await w())),
  ...
  async function s(e) {
    var p, f, b, h;
    if (
      ((p = e.submitter) != null && p.hasAttribute("formmethod")
        ? e.submitter.formMethod
        : y(t).method) !== "post"
    )
      return;
    e.preventDefault();
    const n = new URL(
        (f = e.submitter) != null && f.hasAttribute("formaction")
    ...
    u &&
      r.append(
        u,
        ((h = e.submitter) == null ? void 0 : h.getAttribute("value")) ?? ""
      );
  ...
  return (
    HTMLFormElement.prototype.addEventListener.call(t, "submit", s),
    {
      destroy() {
