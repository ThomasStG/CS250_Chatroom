import { M as me, O as _e } from "../chunks/index.229400e6.js";
import {
  S as Je,
  b as Ke,
  I as q,
  ...
  P as qe,
  k as Xe,
} from "../chunks/singletons.dd9c9a0a.js";
...
window.fetch = (n, o) => (
  (n instanceof Request
    ? n.method
    : (o == null ? void 0 : o.method) || "GET") !== "GET" && ae.delete(Ee(n)),
  ze(n, o)
);
const ae = new Map();
function ct(n, o) {
  ...
  if (c != null && c.textContent) {
    const { body: p, ...b } = JSON.parse(c.textContent),
      E = c.getAttribute("data-ttl");
    return (
      E && ae.set(l, { body: p, init: b, ttl: 1e3 * Number(E) }),
...
function ht(n, o, l) {
  ...
  for (let w = 0; w < o.length; w += 1) {
    ...
    if (!g.matcher || l[g.matcher](m)) {
      ...
      const h = o[w + 1],
        C = p[w + 1];
      h && !h.rest && h.optional && C && g.chained && (E = 0),
        !h && !C && Object.keys(c).length === b.length && (E = 0);
      continue;
    }
...
function bt(n, o) {
  ...
  let h = { branch: [], error: null, url: null },
    ...
    J = !1,
    M,
    j = (je = history.state) == null ? void 0 : je[q];
  j ||
    ((j = Date.now()),
  ...
  async function ke() {
    ...
    if (t === G && r) {
      if (r.type === "redirect")
        return re(new URL(r.location, e).href, {}, 1, t);
      r.props.page !== void 0 && (V = r.props.page), M.$set(r.props);
    }
  }
  function xe(e) {
    w.some((i) => (i == null ? void 0 : i.snapshot)) &&
      (ee[e] = w.map((i) => {
        var t;
  ...
  function Pe(e) {
    ...
    i && i.remove(),
      ...
      (M = new n.root({
        target: o,
        props: { ...e.props, stores: F, components: w },
        hydrate: !0,
      })),
      Re(j);
    const t = {
  ...
  async function ue({
    ...
    return {
      ...
      slash:
        ((x = v.universal) == null ? void 0 : x.trailingSlash) ??
  ...
  async function pe({ id: e, invalidating: i, url: t, params: r, route: a }) {
      ...
      const k = h.branch[R],
        $ =
          ...
          ((k == null ? void 0 : k.loader) !== S[1] ||
            Oe(A, x, L, (K = k.server) == null ? void 0 : K.uses, r));
      return $ && (A = !0), $;
    });
    if (d.some(Boolean)) {
      try {
        ...
        return ie({
          ...
          error: await Z(S, { url: t, params: r, route: { id: a.id } }),
          url: t,
          route: a,
        });
      }
    ...
    const I = v.map(async (S, R) => {
      ...
      if (
        ...
        !Oe(P, x, L, (he = k.universal) == null ? void 0 : he.uses, r)
      )
        return k;
      ...
      return ue({
        ...
        parent: async () => {
          ...
          for (let ge = 0; ge < R; ge += 1)
            Object.assign(Ce, (Te = await I[ge]) == null ? void 0 : Te.data);
          return Ce;
        },
        server_data_node: de(
      ...
      if (v[S])
        try {
          ...
          if (u != null && u.includes(R)) (k = R.status ?? k), ($ = R.error);
            ...
            if (await F.updated.check()) return await W(t);
            $ = await Z(R, { params: r, url: t, route: { id: a.id } });
          }
  ...
  function Ie({ url: e, type: i, intent: t, delta: r }) {
    let a = !1;
    const s = He(h, t, e, i);
  ...
  async function ce({
    ...
    var I, N, S;
    const L = Q(e, !1),
      x = Ie({ url: e, type: s, delta: f, intent: L });
    if (!x) {
      _();
      return;
    }
    const A = j;
    v(), (O = !0), D && F.navigating.set(x.navigation), (G = y);
    let d = L && (await pe(L));
    if (!d) {
      if (ye(e, z)) return await W(e);
      d = await $e(
        e,
        { id: null },
    ...
    if (((e = (L == null ? void 0 : L.url) || e), G !== y))
      return x.reject(new Error("navigation was aborted")), !1;
    if (d.type === "redirect")
      if (r >= 20)
        d = await ie({
          status: 500,
    ...
    if (
      ...
      if (
        ...
        let k = j + 1;
        for (; ee[k] || B[k]; ) delete ee[k], delete B[k], (k += 1);
      }
    }
    if (((g = null), D)) {
      (h = d.state), d.props.page && (d.props.page.url = e);
      const R = (
        await Promise.all(m.on_navigate.map((k) => k(x.navigation)))
    ...
    !t && !P && Se(),
      ...
      s === "popstate" && Re(j),
      x.fulfil(void 0),
      m.after_navigate.forEach((R) => R(x.navigation)),
  ...
  function Ye() {
    ...
    b.addEventListener("mousedown", i),
      b.addEventListener("touchstart", i, { passive: !0 });
    ...
    function r(s, f) {
      const y = Ne(s, b);
      if (!y) return;
      const { url: v, external: _, download: L } = we(y, z);
      if (_ || L) return;
      const x = le(y);
      if (!x.reload)
        if (f <= x.preload_data) {
    ...
    function a() {
      ...
      for (const s of b.querySelectorAll("a")) {
        const { url: f, external: y, download: v } = we(s, z);
        if (y || v) continue;
        const _ = le(s);
        _.reload ||
          (_.preload_code === qe.viewport && t.observe(s),
          _.preload_code === qe.eager && oe(se(f)));
      }
    }
    ...
    _start_router: () => {
      ...
      (history.scrollRestoration = "manual"),
        ...
        b.addEventListener("click", (t) => {
          ...
          if (!r) return;
          const { url: a, external: s, target: f, download: y } = we(r, z);
          if (!a) return;
          if (f === "_parent" || f === "_top") {
          ...
          if (
            ...
            return;
          if (s || v.reload) {
            Ie({ url: a, type: "link" }) ? (O = !0) : t.preventDefault();
            return;
          }
          ...
          if (x !== void 0 && L === location.href.split("#")[0]) {
            if (h.url.hash === a.hash) {
              t.preventDefault(),
                (A = r.ownerDocument.getElementById(x)) == null ||
                  A.scrollIntoView();
              return;
            }
        ...
        b.addEventListener("submit", (t) => {
          ...
          if (ye(f, z)) return;
          const y = t.target,
            { keep_focus: v, noscroll: _, reload: L, replace_state: x } = le(y);
          if (L) return;
      ...
      function e(t) {
        (h.url = t), F.page.set({ ...V, url: t }), F.page.notify();
      }
    },
    _hydrate: async ({
      status: e = 200,
      ...
      ({ params: r = {}, route: a = { id: null } } = Q(y, !1) || {});
      let v;
      try {
            ...
            return (
              ...
              ue({
                ...
                parent: async () => {
                  const P = {};
                  for (let I = 0; I < d; I += 1)
                    Object.assign(P, (await _[I]).data);
                  return P;
                },
        ...
        if (_ instanceof Ve) {
          await W(new URL(_.location, location.href));
          return;
        }
        v = await ie({
          status: _ instanceof ne ? _.status : 500,
          error: await Z(_, { url: y, params: r, route: a }),
          url: y,
          route: a,
        });
      }
  ...
  return new Promise(async (p) => {
    ...
    function g(C) {
      return Qe(C, {
        Promise: (D) =>
          new Promise((T, U) => {
            b.set(D, { fulfil: T, reject: U });
          }),
      });
    }
    let m = "";
    for (;;) {
      const { done: C, value: D } = await E.read();
      if (C && !m) break;
      for (
        m +=
          !D && m
...
`);
        ...
        if (U.type === "data")
          (h = U.nodes) == null ||
            h.forEach((O) => {
              (O == null ? void 0 : O.type) === "data" &&
                ((O.uses = We(O.uses)), (O.data = g(O.data)));
            }),
            p(U);
        else if (U.type === "chunk") {
          const { id: O, data: H, error: J } = U,
            M = b.get(O);
        ...
        if (c.rangeCount === p.length) {
          for (let b = 0; b < c.rangeCount; b += 1) {
            const E = p[b],
              w = c.getRangeAt(b);
            if (
              E.commonAncestorContainer !== w.commonAncestorContainer ||
              E.startContainer !== w.startContainer ||
              E.endContainer !== w.endContainer ||
              E.startOffset !== w.startOffset ||
              E.endOffset !== w.endOffset
            )
              return;
          }
          c.removeAllRanges();
  ...
  return (
    E.catch(() => {}),
    {
      navigation: {
        from: {
          params: n.params,
          route: { id: ((g = n.route) == null ? void 0 : g.id) ?? null },
          url: n.url,
        },
        to: l && {
          ...
          route: {
            id:
              ((m = o == null ? void 0 : o.route) == null ? void 0 : m.id) ??
              null,
          },
          url: l,
        },
